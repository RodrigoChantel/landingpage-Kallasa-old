<main>
                    ...
                    <div class="carousel-item active">
                        <div class="card text-bg-dark rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 d-grid text-center flex-wrap align-content-center justify-content-center">
                                ...
                                <p class="card-text fs-4">Nós estamos aqui para facilitar a sua vida e fazer a sua empresa voar.</p><br>
                                </div>
                                <div class="container-flex d-flex flex-nowrap justify-content-center">
                                    <p class="card-text"><button class="btn btn-light text-black mx-3">VER PLANOS</button></p>
                                    <p class="card-text"><button class="btn btn-danger mx-3">CONVERSAR</button></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="mt-5 social-project">
            <div class="container-flex mt-5 w-100">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-8 bg-company">
                            <div class="card-body d-flex flex-column align-middle h-100 justify-content-center">
                                <h5 class="card-title text-white fs-1 fw-bold">Nossos projetos sociais</h5>
                                <p class="card-text text-white fs-4 mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet soluta, sunt, doloremque totam eaque fugit, quidem sed dolorum quis itaque eveniet non fugiat commodi fuga ex tenetur mollitia culpa vitae!</p>
                            </div>
                        </div>
                        <div class="col-md-4">
        ...
        <section class="employees d-flex flex-wrap justify-content-center my-5">
            <figure class="snip1218">
                ...
                <figcaption>
                    <h3 class=" fs-4">Wilkerson  <span> Berg</span></h3>
                    <h5>Gestor de Marketing</h5>
                    <div class="icons"><a href="#"><i class="fa-brands fa-linkedin"></i></a><a href="#"> <i class="fa-brands fa-instagram"></i></a><a href="#"> <i class="fa-brands fa-discord"></i></a></div>
                </figcaption>
            </figure>
            ...
            <figure class="snip1218">
                ...
                <figcaption>
                    <h3 class=" fs-4">Rodrigo  <span> Chantel</span></h3>
                    <h5>Desenvolvedor</h5>
                    <div class="icons"><a href="#"><i class="fa-brands fa-linkedin"></i></a><a href="#"> <i class="fa-brands fa-instagram"></i></a><a href="#"> <i class="fa-brands fa-discord"></i></a></div>
                </figcaption>
            </figure>
            ...
            <figure class="snip1218">
                ...
                <figcaption>
                    <h3 class=" fs-5">Fernando<span> Cardoso</span></h3>
                    <h5>Ger. Administrativo</h5>
                    <div class="icons"><a href="#"><i class="fa-brands fa-linkedin"></i></a><a href="#"> <i class="fa-brands fa-instagram"></i></a><a href="#"> <i class="fa-brands fa-discord"></i></a></div>
                </figcaption>
            </figure>
            ...
            <figure class="snip1218">
                ...
                <figcaption>
                    <h3 class=" fs-5">Weslei<span> Santos</span></h3>
                    <h5>Designer</h5>
                    <div class="icons"><a href="#"><i class="fa-brands fa-linkedin"></i></a><a href="#"> <i class="fa-brands fa-instagram"></i></a><a href="#"> <i class="fa-brands fa-discord"></i></a></div>
                </figcaption>
            </figure>
            ...
            <figure class="snip1218">
                ...
                <figcaption>
                    <h3 class=" fs-5">Romário<span> Correia</span></h3>
                    <h5>Gestor de Mídias</h5>
                    <div class="icons"><a href="#"><i class="fa-brands fa-linkedin"></i></a><a href="#"> <i class="fa-brands fa-instagram"></i></a><a href="#"> <i class="fa-brands fa-discord"></i></a></div>
                </figcaption>
            </figure>
